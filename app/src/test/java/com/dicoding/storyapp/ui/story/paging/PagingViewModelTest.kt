...
import com.dicoding.storyapp.ui.story.DataDummy
import com.dicoding.storyapp.ui.story.MainDispatcherRule
import com.dicoding.storyapp.ui.story.StoryAdapter
import com.dicoding.storyapp.ui.story.getOrAwaitValue
...
class PagingViewModelTest {
    ...
    fun `when get story should not null and return data`() = runTest {
        ...
        val pagingViewModel = PagingViewModel(storyRepository)
        val actualStory: PagingData<ListStoryItem> = pagingViewModel.story.getOrAwaitValue()
    ...
    @Test
    fun `when get story empty should return empty data`() = runTest {
